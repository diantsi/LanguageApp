...
final class PersistenceClientTests: XCTestCase {
    ...
    override func setUp() async throws {
        ...
        SwiftDataModelContainer.shared = testContainer
        
        client = PersistenceClient.liveValue
    }
    ...
    func testAddAndFetchTerms() async throws {
        ...
        let fetchedTerms = try await client.fetchTerms(nil)
    ...
    func testDeleteTerm() async throws {
        ...
        var fetchedTerms = try await client.fetchTerms(nil)
        XCTAssertEqual(fetchedTerms.count, 1)
        
        try await client.deleteTerm(id)
        
        fetchedTerms = try await client.fetchTerms(nil)
    ...
    func testSearchTerms() async throws {
        ...
        let search1 = try await client.fetchTerms("ap")
        ...
        let search2 = try await client.fetchTerms("банан")
        XCTAssertEqual(search2.count, 1)
        XCTAssertEqual(search2.first?.termText, "banana")
        
        let search3 = try await client.fetchTerms("")
